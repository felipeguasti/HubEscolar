...
const login = async (req, res) => {
  ...
  try {
    // Verifica se email ou senha não foram fornecidos
    if (!email || !password) {
...
const register = async (req, res) => {
  const { name, email, password, address, city, state, zip, schoolName, schoolType, schoolState, schoolCity } = req.body;
  console.log("Dados recebidos:", { name, email, address, city, state, zip, schoolName, schoolType, schoolState, schoolCity });
  ...
  try {
    ...
    // Cria o novo usuário apenas com os campos fornecidos
...
const logout = (req, res) => {
  // Limpa o token do cliente (por exemplo, removendo o token de cookies ou localStorage)
  res.clearCookie('token'); // Se o token estiver armazenado em cookies
